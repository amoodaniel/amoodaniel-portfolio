...
const Anenasawa = () => {
  const projectData = {
    ...
    By combining accessible mobile technology with centralized monitoring, this solution enhances the link between frontline outreach and formal case response. It enables outreach teams and case managers to address GBV incidents with improved speed, accuracy, and care.`,
